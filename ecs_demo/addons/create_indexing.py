...
load_dotenv()
embed_model_path = os.getenv("EMBEDDING_MODEL")
if embed_model_path:
    # 将相对路径转为绝对路径（基于项目根目录）
    embed_model_path = str(Path(__file__).parent.parent / embed_model_path)
else:
    embed_model_path = str(Path(__file__).parent.parent / "models" / "bge-base-zh-v1.5")
...
if __name__ == "__main__":
    neo4j_url = os.getenv("NEO4J_URL", "bolt://52.231.65.205:7687")
